...
namespace EveShopping {
    ...
    internal class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Sorry, you are not the owner of the resource that you want access and only the owner can see it..
        /// </summary>
        internal static string err_notAuthorizedForPage {
            get {
                return ResourceManager.GetString("err_notAuthorizedForPage", resourceCulture);
            }
        }
